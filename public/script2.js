        ...
        <div class="container" >
          <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top w-100">
            ...
            <ul class="nav col-md-4 justify-content-end list-unstyled d-flex">
              ...
              <li class="ms-3"><a class="text-muted" href="https://github.com/Aarav11-vaish"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-github" viewBox="0 0 16 16">
